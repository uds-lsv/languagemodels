...
class OPTWithALiBiAttention(nn.Module):
    ...
    def forward(
        ...
        # ALiBi biases are added to attention weights directly after the dot product
...
# derived from: https://github.com/mosaicml/llm-foundry/blob/6fcc126ea3c2c26d5671b10f9bd79f4206bb68c8/llmfoundry/models/layers/attention.py
...
def build_alibi_attention_bias(n_heads, seq_len, full=False, alibi_bias_max=8):
    ...
    if full:
        ...
        alibi_bias = alibi_bias - torch.arange(
            1 - seq_len, 1, dtype=torch.int32).view(
                1, 1, seq_len, 1)
